...
a2 = math.random(100,2000)
a3 = math.random(100,2000)
a4 = math.random(100,2000)
b2 = math.random(1,99)
b3 = math.random(1,99)
b4 = math.random(1,99)
expr3 = string.format("The %d\\%% of %d", b2,a2)
expr4 = string.format("The %d\\%% of %d", b3, a3)
expr5 =  string.format("The %d\\%% of %d", b4, a4)

a5 = math.random(1000,10000)
b5 = math.random(1,10)
\end{luacode*}
...
Your investment of \directlua{tex.print(a3)} dollars has a return rate of \directlua{tex.print(b2)}\% per year. Complete the following table:
...
\vspace{3em}
\item
\directlua{tex.print(expr4)}
\end{itemize}}
\parbox{.5\textwidth}{\begin{itemize}
\item
\directlua{tex.print(expr5)}
\vspace{6em}
\end{itemize}}
\vspace{3em}
\item
Your investment of \directlua{tex.print(a5)} dollars has a return rate of \directlua{tex.print(b5)}\% per year. Complete the following table:
\vspace{1em}
