...
Consider the function \[f(x) = 2x^2 -6x + 10.\] We want to find its minimum via the \textbf{gradient descent method}. In this lesson, we will use GeoGebra to assist the calculation.
...
\vspace{\stretch{1}}
\item 
Pick a point on the graph, then find the derivative at this point.
\vspace{1em}
\begin{itemize}
\item
...
\end{itemize}
\item Now we start to use the gradient descent to find the minimum of $f(x)$. Start from the point you chose, then
\begin{itemize}
\item
