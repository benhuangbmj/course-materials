...
\vspace{\stretch{1}}
\item 
$\displaystyle \lim_{x\to6}\frac{\sqrt{x-2} - 2}{x-6}$
\vspace{\stretch{1}}
\item
$\displaystyle \lim_{x\to-\infty}\frac{3x^3 - x^2 +4}{6x^3 + x -6}$
\vspace{\stretch{1}}
\item
$\displaystyle \lim_{x\to-\infty}\frac{- 11x^3 -6x}{ 2x^2 -9}$
\vspace{\stretch{1}}
\item
$\displaystyle \lim_{x\to\infty}\frac{x^4 - 3x +5}{-2x^5 + 4x^2 -23}$
\vspace{\stretch{1}}
\end{enumerate}
