...
function printBehaviorReport(record)
	averageViolations = math.floor(congregate(behaviorRecords, getTotalViolations)[1]/congregate(behaviorRecords, getTotalViolations)[2])
	averageParticipation =math.floor(congregate(behaviorRecords, getTotalParticipation)[1]/congregate(behaviorRecords, getTotalViolations)[2])
