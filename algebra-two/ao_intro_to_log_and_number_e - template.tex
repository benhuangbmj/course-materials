...
\begin{enumerate}
\item
(\textbf{Rebuild}) Which expression has a greater value: $\log_{\directlua{b = utils.genRandom(2,5,false,false,true);tex.print(b)}}\directlua{a=utils.genRandom(-3,3, false, false,false);tex.print(utils.printFraction(b,a))}$ or  $\log_{\directlua{b = utils.genRandom(2,5,false,false,true);tex.print(b)}}\directlua{a=utils.genRandom(-3,3, false, false,false);tex.print(utils.printFraction(b,a))}$? Explain how you know.
\vspace{\stretch{1}}
\item
(\textbf{Recap}) Let $b>0$. Which expression has a greater value: $\log_b b^{\directlua{a=utils.genRandom(-4,4, false, false,false);tex.print(a)}}$ or  $\log_{\directlua{b = utils.genRandom(2,5,false,false,true);tex.print(b)}}\directlua{a=utils.genRandom(-3,3, false, false,false);tex.print(utils.printFraction(b,a))}$? Explain how you know.
\vspace{\stretch{1}}
\end{enumerate}
\clearpage
