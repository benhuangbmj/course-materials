...
\usepackage{luacode}
\newcommand{\rulefilldate}{\parbox[t]{8em}{\centering\hrulefill\\\footnotesize mm/dd/yyyy}}
...
for i = 4, #assignmentRecords do
	...
	tex.print("\\noindent\\hrulefill \\raisebox{-.5ex}{\\textit{\\textbf{Out-of-Class Appointment}}} \\hrulefill")
