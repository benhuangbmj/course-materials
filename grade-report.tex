...
\newcommand{\csvsourceOne}{precalculus1-assignments-01062026.csv}
\newcommand{\csvsourceTwo}{PreCalculus-grades-01062026.csv}
...
for i, title in pairs(titles) do
	if title ~= "" and not string.find(title, "Binder Check") then
